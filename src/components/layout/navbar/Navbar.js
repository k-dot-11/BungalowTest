		...
		return (
			<Hidden mdUp>
				...
				>
					...
					<div>
						<List>
							{[ 'STYLING KRNI H ISSKI ABHI', 'CLOSE', 'CLOSE' ].map((text, index) => (
								<ListItem button key={text} onClick={() => setNavBarOpen(false)}>
	...
	return (
		<ThemeContext.Consumer>
			{(context) => {
				...
				return (
					<AppBar position="relative" style={styles.appBar} className={classes.appBar}>
						<Toolbar>
