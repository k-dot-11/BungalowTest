						...
						<Container style={{ flex: 10, paddingRight: '20px', paddingLeft: '20px' }} maxWidth="md">
							<Paper elevation={8} style={{ backgroundColor: theme.primary, padding: '60px' }}>
								<Typography variant="body1" style={{ color: 'white' }} gutterBottom align="center">
									...
									as we continue to celebrate this ode to food.
									<br />
									<br />
									__________________
								</Typography>
								...
								<Typography
									...
									align="center"
								>
									The Colours of festivity, the sounds of joy, the flowers of friendship topped with
									the irresistable taste of authentic vegetarian delicacies You are invited to savour
									the experience with all your senses With family and friends, day after day & Make
									life a celebration!
								</Typography>
							</Paper>
						</Container>
